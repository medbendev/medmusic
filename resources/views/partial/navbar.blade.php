<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
  <a class="navbar-brand" href="#">MedMusic</a>
  ...
  <div class="collapse navbar-collapse" id="navbarCollapse">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="/player">Player <span class="sr-only"></span></a>
      </li>

      <li class="nav-item active">
        <a class="nav-link" href="/musics">Zik<span class="sr-only"></span></a>
      </li>

      <li class="nav-item active">
        <a class="nav-link" href="/artists">Artists<span class="sr-only"></span></a>
      </li>
